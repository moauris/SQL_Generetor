...
namespace SQL_Gen
{
    ...
    {
        String Version_info = "SQL Generator v0.1.015";
        /*
         * v0.1.003
         * The M/Agent and jobcode generater should read lines as seperator too.
         * v0.1.015
         * For failsave, click on anything at all must clear the result tab.
         * Also clipboard feature needs to be added.
         */
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            //checkBox3.Click += new System.EventHandler(button_click_clear_result);
            ...
            checkBox4.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox5
            // 
            ...
            checkBox5.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox6
            // 
            ...
            checkBox6.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox7
            // 
            ...
            checkBox7.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox8
            // 
            ...
            checkBox8.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox9
            // 
            ...
            checkBox9.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox10
            // 
            ...
            checkBox10.Click += new System.EventHandler(button_click_clear_result);
            // 
            // checkBox11
            // 
            ...
            checkBox11.Click += new System.EventHandler(button_click_clear_result);
            // 
            // label3
            // 
            ...
            textBox1.Click += new System.EventHandler(button_click_clear_result);
            // 
            // label4
            // 
            ...
            radioButton1.Click += new System.EventHandler(button_click_clear_result);
            // 
            // radioButton2
            // 
            ...
            radioButton2.Click += new System.EventHandler(button_click_clear_result);
            // 
            // button1
            // 
        ...
        private void button_click_clear_result(object sender, EventArgs e)
        {
            textBox2.Text = "";
        }

        void Click_do(bool asFile)
        {
        ...
        string Parse_DC_Gen()
        {
            ...
            Boolean unchecked_sw = false; // Assume all are checked, be true if unchecked.
            ...
            if (unchecked_sw == true)
                return sb1.ToString();
            else
                return "ALL_DC_CHECKED";
        ...
        public class Gen_sql_ma
        {
            ...
            private string sql1 = "SELECT j.memname, " +
                ...
                "   AND j.task_type != 'Dummy'\r\n" +
                "   AND j.parent_table != 'NETCHK'\r\n" +
                " AND ";
            ...
            public string Gen(string s_DC, string s_PARAM)
            {
                ...
                sb_sql2.Append("\r\n AND ");
                //s_PARAM 'abc10101%'
                string[] stra2 = Fn.delimit_param(str_param);
                sb_sql3.Append("( ");
                ix = stra2.Count() - 1;
                for (int i = 0; i < ix; i++)
                {
                ...
                string sql_out = "";
                if (str_dc == "ALL_DC_CHECKED")
                    sql_out = sql1 + sb_sql3.ToString();
                else
                    sql_out = sql1 + sb_sql2.ToString() + sb_sql3.ToString();
                return sql_out;
            }
        ...
        public class Gen_sql_shout
        {
            ...
            public string Gen(string s_DC, string s_PARAM)
            {
                ...
                string[] stra2 = Fn.delimit_param(s_PARAM);
                sb_sql3.Append("( ");
                ix = stra2.Count() - 1;
                for (int i = 0; i < ix; i++)
                {
        ...
        public class Fn
        {
            public static string[] delimit_param(string S_PARAM)
            {
                //*MA*,*MA1*,*MA2*...
                //*MA*;*MA1*;*MA2*...
                //*MA*/r/n*MA1*/r/n*MA2*...
                string[] stra1 = S_PARAM
                    .Replace("*", "%")
                    .Replace("\r\n", ",")
                    .Replace(";", ",")
                    .Split(',');
                //use linq to eliminate the 0 length
                IEnumerable<string> linq1 =
                    from n in stra1
                    where n.Length > 0
                    select n;
                stra1 = linq1.ToArray();
